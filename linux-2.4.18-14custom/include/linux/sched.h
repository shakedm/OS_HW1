...
/* our added fields for HW1 */
	bool HW1_policy_enable;
	int HW1_Privileg_Level;
	forbidden_log_HW1 head_log;
	forbidden_log_HW1 last_log;
...
{									\
    ...
    journal_info:	NULL,						\
	HW1_policy_enable: false, 					\
	HW1_Privileg_Level: 2,						\
	head_log: 		 NULL,						\
	last_log:		NULL,						\
}
